...
apiRouter.get("/styles", validateAccessToken, async (req, res) => {
  const styles = await prisma.style.findMany();
  res.json(styles);
});

apiRouter.get("/artistes", validateAccessToken, async (req, res) => {
...
apiRouter.get("/api/proportions", validateAccessToken, async (req, res) => {
